...
// ≡ƒö╣ Demo Login ΓÇö prefill credentials and reuse existing login()
const DEMO_ACCOUNTS = {
      ...
      <div class="login-body auth-card">
        ...
        <div class="bottom auth-content auth-column">
          ...
          <form @submit.prevent="login" class="auth-form">
            ...
            <!-- Demo mode buttons ΓÇö only visible when VITE_OPERATING_MODE=demo -->
      ...
      >
        <div class="login-diagnostics-modal" role="dialog" aria-modal="true" aria-label="Login diagnostics">
          ...
          <div class="login-diagnostics-body">
            ...
            <!-- Server diagnostics -->
            <div v-if="diagnosticsLoading" class="login-diag-loading">Loading diagnosticsΓÇª</div>
...
/* ΓöÇΓöÇ Login diagnostics button row ΓöÇΓöÇ */
...
/* ΓöÇΓöÇ Diagnostics button ΓÇö amber, defeats Bootstrap ΓöÇΓöÇ */
...
/* ΓöÇΓöÇ Demo mode buttons ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.demo-divider {
  display: flex;
  align-items: center;
  gap: 8px;
...
/* ΓöÇΓöÇ Diagnostics modal: loading / contact-admin ΓöÇΓöÇ */
.login-diag-loading {
  color: #a9c4ff;
  font-size: 0.84rem;
  padding: 10px 0;
...
/* ΓöÇΓöÇ Diagnostics modal: structured sections ΓöÇΓöÇ */
.login-diag-section {
  margin-bottom: 14px;
}
...
/* ΓöÇΓöÇ Client diagnostics collapsible ΓöÇΓöÇ */
