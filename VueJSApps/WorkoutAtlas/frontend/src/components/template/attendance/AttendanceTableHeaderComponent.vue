...
<template>
  <div class="digi-dropdown dropdown">
    ...
    <ul class="dropdown-menu">
      ...
      <li>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" id="showDivision" checked>
          <label class="form-check-label" for="showDivision">
            Division
          </label>
        </div>
      </li>
      <li>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" id="showChekinCheckout" checked>
          <label class="form-check-label" for="showChekinCheckout">
            Chek In - Check Out
          </label>
        </div>
      </li>
      ...
      <li>
        <div class="form-check">
          <input class="form-check-input" type="checkbox" id="showShift" checked>
